...
/**
	...
	as a back-end.
*/
public class TestSignalFormat_Described extends TestSuite
{
	@BeforeClass public static void setupTestSuiteFactory()
	{
		...
		{
			public Pair create(final String test_class_name, final String test_name)throws IOException	
			{
					...
					new CSignalWriteFormat(
						new CIndicatorWriteFormatProtector(
							new CDumpingObjIndicatorWriteFormat(
											...
											new File("test-data/d"), //final File folder,
