...
import sztejkat.abstractfmt.EBrokenStream;
...
/**
		...
		<p>
		This implementation is undescribed, but due to boxed
		nature is performing <i>some</i> type checking. Most
		strict for block operations and more lenient for elementary
		operations.
		<p>
		Also due to need of "stitching" block operations during
		read this class do understand FLUSH indicators as end-of-block
		and passes them up to superclass routines, so described 
		subclasses may just override {@link #isDescribed} to return true.
...
public class CObjListReadFormat extends ASignalReadFormat
{
		...
		***************************************************************/
		...
		/*............................................................		
				...
				Note: All block reads do "stitch" adjacent blocks, thous
