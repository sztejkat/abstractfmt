...
/**
	...
	made around {@link CFullyDescrObjListWriteFormat}	
*/
public class TestASignalWriteFormat_FullyDescr extends sztejkat.utils.test.ATest
{
	@org.junit.Test public void testPrimitiveTypePresence()throws IOException
	{
		enter();
			...
			*/
			...
			ISignalWriteFormat f = new CFullyDescrObjListWriteFormat(
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_BOOLEAN_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_BYTE);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof Byte);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_BYTE_END);
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_CHAR_END);
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_SHORT_END);
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_INT_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_LONG);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof Long);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_LONG_END);
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_FLOAT_END);
			...
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_DOUBLE_END);
		leave();
	};
	@org.junit.Test public void testBlockTypePresence1()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof boolean[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof boolean[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_BOOLEAN_BLOCK_END);
	...
	@org.junit.Test public void testBlockTypePresence2()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof byte[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof byte[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_BYTE_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence3()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof char[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_CHAR_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence4()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof short[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof short[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_SHORT_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence5()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof int[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_INT_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence6()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof long[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof long[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_LONG_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence7()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof float[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof float[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_FLOAT_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
	...
	@org.junit.Test public void testBlockTypePresence8()throws IOException
	{
		enter();
			...
			*/
			...
			org.junit.Assert.assertTrue(m.pollFirst() instanceof double[]);
			org.junit.Assert.assertTrue(m.pollFirst() instanceof double[]);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.TYPE_DOUBLE_BLOCK_END);
			org.junit.Assert.assertTrue(m.pollFirst()==CObjListFormat.END_INDICATOR);
